...
# プレイヤーがいない場合のみモンスター召喚 必ず20t分猶予を設けること
execute unless score $dungeon_0 level.dungeon.dungeonPlayers matches 1.. run schedule function level:dungeon/dungeon_0/init 20t
