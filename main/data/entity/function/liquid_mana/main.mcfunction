...
execute as @a[distance=..1.0] at @s run summon area_effect_cloud ~ ~ ~ {Duration:6,Age:4,effects:[{id:"minecraft:speed",amplifier:1b,duration:5,show_particles:0b,show_icon:0b,ambient:1b}]}
