...
execute unless entity @s[tag=this.burst,tag=this.hit_block,tag=this.kill] if score @s entity.fire_magic_book_fire.time matches 9.. run tag @s add this.burst
