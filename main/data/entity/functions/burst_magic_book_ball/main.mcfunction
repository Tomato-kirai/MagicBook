...
execute unless entity @s[tag=this.burst,tag=this.hit_block,tag=this.kill] if score @s entity.fire_magic_book_fire.move matches ..10 positioned as @s run return run function entity:burst_magic_book_ball/main
